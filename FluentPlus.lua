...
Components.Tab = (function()
	...
	function TabModule:GetCurrentTabPos()
		...
		if not TabModule.Tabs[TabModule.SelectedTab] then return 36 end
	...
	return function(Config, _36)
		...
		local TabFrame = New("Frame", {
			...
			New("ImageLabel", {
				...
				BackgroundTransparency = 1,
				Image = _G.modbynoguchihyuga or "rbxassetid://88776023850919"
			})
		})
		...
		if Config.UserInfo then
			...
			if Config.UserInfoTop then
				...
				Window.TabHolder.Size = UDim2.new(1, 0, 0.5, 0)
		...
		Window.SelectorPosMotor:onStep(function(Value)
			...
			if Window.UserInfoHeight then
				...
				local userInfoTop = Window.TabHolder.AbsolutePosition.Y
...
Library.CreateWindow = function(self, Config, _36_)
