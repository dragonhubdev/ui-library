...
local IndexUIColor = {
	...
	["Title Text Color"] = Color3.fromRGB(255, 150, 150),
	...
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(255, 150, 150),
	["Section Text Color"] = Color3.fromRGB(255, 150, 150),
	["Section Underline Color"] = Color3.fromRGB(255, 150, 150),
	["Toggle Border Color"] = Color3.fromRGB(255, 150, 150),
	...
	["Dropdown Selected Color"] = Color3.fromRGB(255, 150, 150),
	["Dropdown Selected Check Color"] = Color3.fromRGB(255, 150, 150),
	["Textbox Highlight Color"] = Color3.fromRGB(255, 150, 150),
	["Box Highlight Color"] = Color3.fromRGB(255, 150, 150),
	["Slider Line Color"] = Color3.fromRGB(255, 150, 150),
	["Slider Highlight Color"] = Color3.fromRGB(255, 150, 150),
...
local onff = Instance.new("ImageButton",Library_Function.HideGui);
onff["BorderSizePixel"] = 0;
onff["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
onff["AnchorPoint"] = Vector2.new(0, 1);
onff["Image"] = [[rbxassetid://82079893387523]];
onff["Size"] = UDim2.new(0, 50, 0, 50);
onff["BorderColor3"] = Color3.fromRGB(0, 0, 0);
onff["Position"] = UDim2.new(0.01, 0, 0.99, 0);
makeDraggable(onff,onff)
onff.MouseButton1Down:Connect(function()
	Library_Function.Gui.Enabled = not Library_Function.Gui.Enabled
end)
local onfff = Instance.new("UICorner", onff);
onfff["CornerRadius"] = UDim.new(1, 8);

local onffff = Instance.new("UIStroke", onff);
onffff["Thickness"] = 0.6;
onffff["Color"] = Color3.fromRGB(255, 150, 150);
...
local libCreateNoti = function(Setting)
	...
	TextLabelNoti.Text = "<font color=\"rgb(" .. color .. ")\">Dragon Hub</font> "..cache.TitleNameNoti
...
function Library.CreateMain(Setting)
	...
	local colorB = tostring(Library_Function.Getcolor(cache.UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
	TextLabelMain.Text = "<font color=\"rgb("..color..")\">Dragon Hub </font> " .. ": Blox Fruit"
	...
	Ruafimg.Position = UDim2.new(0, 5, 0, cache.T1 and 5 or 0)
	Ruafimg.Size = UDim2.new(0, cache.T1 and 30 or 25, 0, cache.T1 and 15 or 25)
	Ruafimg.Image = "rbxassetid://82079893387523"
	...
	function Main_Function.CreatePage(Setting)
		...
		function pageFunction.CreateSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			function sectionFunction.CreateToggle(Setting, Callback)
				...
				check.BackgroundColor3 = Color3.fromRGB(255, 150, 150)
			...
			function sectionFunction.CreateButton(Setting, Callback)
				...
				--table.insert(cache.listfunction[Section], {Type = "Button",Name = Title})
				local Callback = Callback or function() end

				local noguchi_1 = Instance.new("Frame", Section)

				noguchi_1.LayoutOrder = 0
				noguchi_1.BorderMode = Enum.BorderMode.Outline
				noguchi_1.Selectable = false
				noguchi_1.AnchorPoint = Vector2.new(0, 0)
				noguchi_1.AutomaticSize = Enum.AutomaticSize.None
				noguchi_1.Size = UDim2.new(1, 0, 0, 40)
				noguchi_1.Draggable = false
				noguchi_1.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_1.Style = Enum.FrameStyle.Custom
				noguchi_1.Transparency = 1
				noguchi_1.BackgroundTransparency = 1
				noguchi_1.SelectionOrder = 0
				noguchi_1.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_1.BackgroundColor3 = Color3.new(0.6392157077789307, 0.6352941393852234, 0.6470588445663452)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG
				local noguchi_2 = Instance.new("Frame", noguchi_1)

				noguchi_2.LayoutOrder = 0
				noguchi_2.BorderMode = Enum.BorderMode.Outline
				noguchi_2.Selectable = false
				noguchi_2.AnchorPoint = Vector2.new(0.5, 0.5)
				noguchi_2.AutomaticSize = Enum.AutomaticSize.None
				noguchi_2.Size = UDim2.new(1, -10, 1, 0)
				noguchi_2.Draggable = false
				noguchi_2.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_2.Style = Enum.FrameStyle.Custom
				noguchi_2.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_2.Transparency = cache.UIColor["Background 1 Transparency"]
				noguchi_2.BackgroundTransparency = 0.25
				noguchi_2.Position = UDim2.new(0.5, 0, 0.5, 0)
				noguchi_2.SelectionOrder = 0
				noguchi_2.BackgroundColor3 = cache.UIColor["Background 1 Color"]

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.UICorner
				local noguchi_3 = Instance.new("UICorner", noguchi_2)

				noguchi_3.CornerRadius = UDim.new(0, 10)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.RowHover
				local noguchi_4 = Instance.new("Frame", noguchi_2)

				noguchi_4.LayoutOrder = 0
				noguchi_4.BorderMode = Enum.BorderMode.Outline
				noguchi_4.Selectable = false
				noguchi_4.AnchorPoint = Vector2.new(0, 0)
				noguchi_4.ZIndex = 2
				noguchi_4.AutomaticSize = Enum.AutomaticSize.None
				noguchi_4.Draggable = false
				noguchi_4.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_4.Style = Enum.FrameStyle.Custom
				noguchi_4.Transparency = 1
				noguchi_4.BackgroundTransparency = 1
				noguchi_4.SelectionOrder = 0
				noguchi_4.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_4.BackgroundColor3 = Color3.new(0.1882352977991104, 0.1882352977991104, 0.21960784494876862)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.RowHover.UICorner
				local noguchi_5 = Instance.new("UICorner", noguchi_4)

				noguchi_5.CornerRadius = UDim.new(0, 10)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.TextColor
				local noguchi_6 = Instance.new("TextLabel", noguchi_2)

				noguchi_6.LineHeight = 1
				noguchi_6.Active = false
				noguchi_6.TextStrokeTransparency = 0.8500000238418579
				noguchi_6.TextTruncate = Enum.TextTruncate.None
				noguchi_6.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_6.ZIndex = 1
				noguchi_6.BorderSizePixel = 1
				noguchi_6.Draggable = false
				noguchi_6.RichText = false
				noguchi_6.SelectionOrder = 0
				noguchi_6.BackgroundColor3 = Color3.new(0.6392157077789307, 0.6352941393852234, 0.6470588445663452)
				noguchi_6.BorderMode = Enum.BorderMode.Outline
				noguchi_6.TextStrokeColor3 = Color3.new(0, 0, 0)
				noguchi_6.AnchorPoint = Vector2.new(0, 0)
				noguchi_6.AutomaticSize = Enum.AutomaticSize.None
				noguchi_6.Size = UDim2.new(1, -110, 1, 0)
				noguchi_6.TextColor3 = Color3.new(0.9215686321258545, 0.9215686321258545, 0.9019607901573181)
				noguchi_6.ClipsDescendants = false
				noguchi_6.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_6.Text = Title
				noguchi_6.TextXAlignment = Enum.TextXAlignment.Left
				noguchi_6.LayoutOrder = 0
				noguchi_6.Rotation = 0
				noguchi_6.Font = Enum.Font.GothamBold
				noguchi_6.BackgroundTransparency = 1
				noguchi_6.Position = UDim2.new(0, 12, 0, 0)
				noguchi_6.Selectable = false
				noguchi_6.MaxVisibleGraphemes = -1
				noguchi_6.Visible = true
				noguchi_6.TextSize = 14
				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea
				local noguchi_7 = Instance.new("Frame", noguchi_2)

				noguchi_7.LayoutOrder = 0
				noguchi_7.BorderMode = Enum.BorderMode.Outline
				noguchi_7.Selectable = false
				noguchi_7.AnchorPoint = Vector2.new(1, 0.5)
				noguchi_7.AutomaticSize = Enum.AutomaticSize.None
				noguchi_7.Size = UDim2.new(0, 94, 0, 30)
				noguchi_7.Draggable = false
				noguchi_7.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_7.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_7.Transparency = 0
				noguchi_7.Style = Enum.FrameStyle.Custom
				noguchi_7.Position = UDim2.new(1, -8, 0.5, 0)
				noguchi_7.SelectionOrder = 0
				noguchi_7.BackgroundColor3 = Color3.new(0.6392157077789307, 0.6352941393852234, 0.6470588445663452)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.UICorner
				local noguchi_8 = Instance.new("UICorner", noguchi_7)

				noguchi_8.CornerRadius = UDim.new(0, 12)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.UIGradient
				local noguchi_9 = Instance.new("UIGradient", noguchi_7)

				noguchi_9.Enabled = true
				noguchi_9.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0, 0, 0), NumberSequenceKeypoint.new(1, 0, 0)})
				noguchi_9.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(255, 150, 150)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(255, 150, 150))}
				noguchi_9.Offset = Vector2.new(0, 0)
				noguchi_9.Rotation = 90

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.Button
				local noguchi_10 = Instance.new("TextButton", noguchi_7)

				noguchi_10.Visible = true
				noguchi_10.TextWrapped = false
				noguchi_10.LineHeight = 1
				noguchi_10.Active = true
				noguchi_10.TextStrokeTransparency = 1
				noguchi_10.TextTruncate = Enum.TextTruncate.None
				noguchi_10.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_10.ZIndex = 1
				noguchi_10.BorderSizePixel = 1
				noguchi_10.Draggable = false
				noguchi_10.RichText = false
				noguchi_10.AutoButtonColor = false
				noguchi_10.Transparency = 1
				noguchi_10.SelectionOrder = 0
				noguchi_10.TextYAlignment = Enum.TextYAlignment.Center
				noguchi_10.TextScaled = false
				noguchi_10.BackgroundColor3 = Color3.new(0.6392157077789307, 0.6352941393852234, 0.6470588445663452)
				noguchi_10.BorderMode = Enum.BorderMode.Outline
				noguchi_10.Selectable = true
				noguchi_10.AnchorPoint = Vector2.new(0, 0)
				noguchi_10.Style = Enum.ButtonStyle.Custom
				noguchi_10.Modal = false
				noguchi_10.Selected = false
				noguchi_10.AutomaticSize = Enum.AutomaticSize.None
				noguchi_10.Size = UDim2.new(1, 0, 1, 0)
				noguchi_10.TextXAlignment = Enum.TextXAlignment.Center
				noguchi_10.TextTransparency = 0
				noguchi_10.ClipsDescendants = false
				noguchi_10.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_10.Text = "Click"
				noguchi_10.LayoutOrder = 0
				noguchi_10.TextStrokeColor3 = Color3.new(0, 0, 0)
				noguchi_10.Rotation = 0
				noguchi_10.Font = Enum.Font.GothamBold
				noguchi_10.BackgroundTransparency = 1
				noguchi_10.Position = UDim2.new(0, 0, 0, 0)
				noguchi_10.TextSize = 13
				noguchi_10.MaxVisibleGraphemes = -1
				noguchi_10.TextColor3 = Color3.new(0.09803921729326248, 0.10980392247438431, 0.1411764770746231)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.Frame
				local noguchi_11 = Instance.new("Frame", noguchi_7)

				noguchi_11.LayoutOrder = 0
				noguchi_11.BorderMode = Enum.BorderMode.Outline
				noguchi_11.Selectable = false
				noguchi_11.AnchorPoint = Vector2.new(0.5, 0)
				noguchi_11.ZIndex = 2
				noguchi_11.AutomaticSize = Enum.AutomaticSize.None
				noguchi_11.Size = UDim2.new(1, -6, 0, 10)
				noguchi_11.Draggable = false
				noguchi_11.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_11.Style = Enum.FrameStyle.Custom
				noguchi_11.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_11.Transparency = 0.8500000238418579
				noguchi_11.BackgroundTransparency = 0.8500000238418579
				noguchi_11.Position = UDim2.new(0.5, 0, 0, 2)
				noguchi_11.SelectionOrder = 0
				noguchi_11.BackgroundColor3 = Color3.new(1, 1, 1)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.Frame.UICorner
				local noguchi_12 = Instance.new("UICorner", noguchi_11)

				noguchi_12.CornerRadius = UDim.new(0, 4)

				-- CoreGui.Nousigi Hub GUI.Main.MainContainer.Concacontainer.Concacmain.MainPage.Page1.PageList.Misc Shop_Dot.Redeem Code_Row.RowBG.ClickArea.ImageLabel
				local noguchi_13 = Instance.new("ImageLabel", noguchi_7)

				noguchi_13.LayoutOrder = 0
				noguchi_13.BorderMode = Enum.BorderMode.Outline
				noguchi_13.SliceCenter = Rect.new(24, 24, 276, 276)
				noguchi_13.Active = false
				noguchi_13.Selectable = false
				noguchi_13.Visible = true
				noguchi_13.ImageTransparency = 0.550000011920929
				noguchi_13.ImageColor3 = Color3.new(1, 1, 1)
				noguchi_13.AnchorPoint = Vector2.new(0.5, 0.5)
				noguchi_13.Image = "rbxassetid://5028857084"
				noguchi_13.ImageRectOffset = Vector2.new(0, 0)
				noguchi_13.ImageRectSize = Vector2.new(0, 0)
				noguchi_13.ZIndex = 0
				noguchi_13.AutomaticSize = Enum.AutomaticSize.None
				noguchi_13.Size = UDim2.new(1, 14, 1, 14)
				noguchi_13.Draggable = false
				noguchi_13.ScaleType = Enum.ScaleType.Slice
				noguchi_13.BorderColor3 = Color3.new(0.10588235408067703, 0.16470588743686676, 0.2078431397676468)
				noguchi_13.SizeConstraint = Enum.SizeConstraint.RelativeXY
				noguchi_13.SelectionOrder = 0
				noguchi_13.ClipsDescendants = false
				noguchi_13.Rotation = 0
				noguchi_13.Transparency = 1
				noguchi_13.BackgroundTransparency = 1
				noguchi_13.Position = UDim2.new(0.5, 0, 0.5, 0)
				noguchi_13.SliceScale = 1
				noguchi_13.BorderSizePixel = 1
				noguchi_13.BackgroundColor3 = Color3.new(0.6392157077789307, 0.6352941393852234, 0.6470588445663452)
				noguchi_10.MouseButton1Click:Connect(function()
					Callback()
				end)
				function visibleon()
					noguchi_1.Visible = true
				end
				table.insert(cache.listfunction[Section], {Type = "Toggle",Name = Title, Call = visibleon})
				table.insert(allfunc[Section], noguchi_1)
			end
...
--thua()
--local search = "click"
--rconsoleprint(game:GetService("HttpService"):JSONEncode(cache.listfunction))
--gg()
--for i, vv in pairs(cache.listfunction) do
--	rconsoleprint(i)
--	--rconsoleprint(game:GetService("HttpService"):JSONEncode(cache.listfunction))

--	for idx,vl in pairs(vv) do
--		if string.find(vl["Name"]:lower(), search:lower()) then
--			vl["Call"]()
--			rconsoleprint("true")
--			cache.listtab[i][1].Visible = true
--			cache.listtab[i][2].Visible = true
--			cache.listtab[i][3].Visible = true
