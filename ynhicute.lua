...
if getgenv().Nousigi then 
    if game.CoreGui:FindFirstChild("Rua Hub GUI") then
        for i, v in ipairs(game.CoreGui:GetChildren()) do
            if string.find(v.Name, "Rua Hub") then
                v:Destroy()
            end
        end
    end
...
local T1UIColor = {
    ...
    ["Logo Image"] = "rbxassetid://124762714875426",
    ["Search Icon Color"] = Color3.fromRGB(0, 255, 127),
    ["Search Icon Highlight Color"] = Color3.fromRGB(150, 255, 150),
...
Library_Function.Gui.Name = 'Rua Hub GUI'
...
ToggleScreenGui.Name = "ShinichiWindowsToggleUltimate"
...
ImageLabel.Image = "rbxassetid://124762714875426"
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "Rua Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "Rua Hub"
   ...
   TextLabelMain.Text = "<font color=\"rgb(0,0,0)\">" .. tostring(TitleNameMain or "Rua Hub") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
